...
export type RenderExportFormat = "png" | "jpeg";
export type ExportFormat = RenderExportFormat | "dng" | "dng-png" | "dng-jpeg";
export type ExportUpscaleAlgorithm = "nearest" | "bilinear" | "lanczos3";
export type ExportUpscaleScale = 1 | 2 | 3 | 4 | 6 | 8;
...
export interface ExportUpscaleSettings {
  scale: ExportUpscaleScale;
  algorithm: ExportUpscaleAlgorithm;
}
